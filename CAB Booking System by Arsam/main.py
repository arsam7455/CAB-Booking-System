...
def RegisterPage():
    ...
    global securityanswer
    canvas.delete('all')
    backgroundIMG=PhotoImage(file="register.gif")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(90,100,430,550,fill="yellow",outline="black")
    canvas.create_text(250,140,text="Register",fill='black',font=("Arial",25,'bold','underline'))
    ...
    Regbutton=Button(canvas,text="Register",width=10,fg="yellow",bg="#000",font=("Arial",13,'bold'),command=RegisterNow)
    canvas.create_window(200,500,window=Regbutton)
    Loginbutton=Button(canvas,text="Login",fg="yellow",bg="#000",bd=0,font=("Arial",13,'bold'),command=loginpage)
...
def feedpage():
    ...
    global feedEntry
    canvas.delete('all')
    gifimg=PhotoImage(file="fd.gif")
    canvas.create_image(0,0,image=gifimg,anchor=NW)
    rebutton=Button(canvas,text="booking page",width=15,fg="black",bg="yellow",bd=0,font=("Arial",13,'bold'),command=gotocpage)
    canvas.create_window(1200,50,window=rebutton)
    ebutton=Button(canvas,text="Give Review",width=15,fg="black",bg="yellow",font=("Arial",15,'bold'),command=submitreview)
    canvas.create_window(850,650,window=ebutton)
    canvas.create_text(683,100,text="Feedback" ,fill="black",font=("Arial",25,'underline'))
    canvas.create_text(400,300,text="Rating" ,fill="black",font=("Arial",13))
    canvas.create_text(400,450,text="Review" ,fill="black",font=("Arial",13))
    var = StringVar(root)
    var.set(1)
    secmenu=  ttk.Combobox(root, width=30,height=20,textvariable=var)
...
def viewbooking():
    ...
    rebutton=Button(canvas,text="Booking page",width=15,fg="white",bg="red",bd=0,font=("Arial",15,'bold'),command=gotocpage)
    canvas.create_window(1200,50,window=rebutton)
    backgroundIMG=PhotoImage(file="fd.gif")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    x,y=0,30
    canvas.create_rectangle(150,20,1250,500,fill="yellow")
    canvas.create_text(683,50,text="Your bookings " ,fill="black",font=("Arial",25,'bold','underline'))
    try:
        ...
        for j in range(len(h)):
                canvas.create_text(200+x,110,text=str(h[j]) ,fill="black",font=("Arial",13,'bold'))
                x+=200
        for i in range(len(hiss)):
            ...
            for j in range(len(xi)):
                canvas.create_text(200+x,110+y,text=str(xi[j]) ,fill="black",font=("Arial",12))
                x+=200
            y+=30
    except:
...
def forgotpage():
    ...
    global backgroundIMG
    canvas.delete('all')
    backgroundIMG=PhotoImage(file="forget.gif")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(90,150,430,550,fill="yellow",outline="black")
    canvas.create_text(240,200,text="Reset Password",fill='black',font=("Arial",25,'bold','underline'))
    ...
    Resetbutton=Button(canvas,text="Reset Password",width=15,fg="yellow",bg="#000",font=("Arial",13,'bold'),command=forgotpass)
...
def cabbook():
    ...
    backgroundIMG=PhotoImage(file="login2.gif")
    canvas.create_image(0,100,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(0,0,1366,200,fill="yellow",outline="black")
    canvas.create_rectangle(590,200,890,500,fill="white")
    canvas.create_text(20,30,text="Quick Cab.com",fill='black',font=("bauhaus 93",25),anchor=NW)
    canvas.create_text(20,60,text="Taxi, The spirit of Indian style",fill='black',font=("Lucida calligraphy",15),anchor=NW)
    IndiaMap=PhotoImage(file="map.png")
    canvas.create_image(683,140,image=IndiaMap)
    canvas.create_text(580,100,text="O",fill='black',font=("Comic sans",13))
    canvas.create_text(580,120,text=".",fill='black',font=("Comic sansr",20))
    canvas.create_text(580,135,text=".",fill='black',font=("Comic sans",20))
    canvas.create_text(620,100,text="From",fill='black',font=("Arial",10))
    canvas.create_text(610,170,text="To",fill='black',font=("Arial",10))
    Locicon=PhotoImage(file="2.gif")
    ...
    bookbutton=Button(canvas,text="Book Ride",width=10,fg="yellow",bg="#000",font=("Arial",13,'bold'),command=book)
    ...
    canvas.pack()
    detbutton=Button(canvas,text="View Past booking",width=15,fg="yellow",bg="black",bd=0,font=("Arial",13,'bold'),command=viewbooking)
    canvas.create_window(1200,90,window=detbutton)
    lobutton=Button(canvas,text="Logout",width=15,fg="yellow",bg="black",bd=0,font=("Arial",13,'bold'),command=loginpage)
    canvas.create_window(1200,180,window=lobutton)
    cpbutton=Button(canvas,text="Change your Password",width=20,fg="yellow",bg="black",bd=0,font=("Arial",13,'bold'),command=changepasswordpage)
    canvas.create_window(1200,110,window=cpbutton)
    revbutton=Button(canvas,text="Review",width=20,fg="yellow",bg="black",bd=0,font=("Arial",13,'bold'),command=feedpage)
...
def showfeed():
    ...
    canvas.create_window(1200,50,window=rebutton)
    backgroundIMG=PhotoImage(file="admin.gif")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    x,y=0,30
    canvas.create_rectangle(150,20,1250,500,fill="yellow")
    canvas.create_text(683,50,text="Reviews " ,fill="black",font=("Arial",25,'bold'))
    try:
        ...
        for j in range(len(h)):
                canvas.create_text(210+x,110,text=str(h[j]) ,fill="black",font=("Arial",13,'bold'))
                x+=380
        for i in range(len(hiss)):
            x=0
            xi=hiss[i].split('|')
            xi[-1]=xi[-1].rstrip()
            for j in range(len(xi)):
                canvas.create_text(200+x,110+y,text=str(xi[j]) ,fill="black",font=("Arial",12),anchor=NW)
                x+=380
            y+=30
    except:
        canvas.create_text(700,280,text="No Reviews to show" ,fill="black",font=("Arial",12))
def adminloginpage():
    global root
    global backgroundIMG
    global userEntered
    ...
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(90,150,430,550,fill="yellow",outline="black")
    canvas.create_text(250,200,text="Admin Login",fill='black',font=("Arial",25,'bold','underline'))
    canvas.create_text(150,300,text="Username",fill='black',font=("Arial",13,'bold'))
    ...
    Loginbutton=Button(canvas,text="Login",width=10,fg="yellow",bg="#000",font=("Arial",13,'bold'),command=cadminlogin)
    canvas.create_window(200,450,window=Loginbutton)
    sbutton=Button(canvas,text="User section",width=10,fg="yellow",bg="#000",bd=0,font=("Arial",13,'bold'),command=loginpage)
...
def changepasswordpage():
    ...
    backgroundIMG=PhotoImage(file="fd.gif")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(600,150,1000,550,fill="yellow",outline="black")
    canvas.create_text(780,200,text="Reset Password",fill='black',font=("Arial",25,'bold'))
    ...
    Resetbutton=Button(canvas,text="Reset Password",width=15,fg="yellow",bg="#000",font=("Arial",13,'bold'),command=changepass)
    canvas.create_window(760,450,window=Resetbutton)
    backbutton=Button(canvas,text="Back",fg="yellow",bg="#000",bd=0,font=("Arial",13,'bold'),command=gotocpage)
...
def loginpage():
    ...
    global canvas
    canvas.delete('all')
    backgroundIMG=PhotoImage(file="login.gif")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(90,150,430,550,fill="yellow",outline="black")
    canvas.create_text(250,200,text="Login",fill='black',font=("Arial",25,'bold','underline'))
    canvas.create_text(150,300,text="Username",fill='black',font=("Arial",13,'bold'))
    userEntered=Entry(canvas,bd=4,font=("Arial",13,'bold'))
    canvas.create_text(150,350,text="Password",fill='black',font=("Arial",13,'bold'))
    passEntered=Entry(canvas,bd=4,font=("Arial",13,'bold'),show='*')
    canvas.create_window(300,300,window=userEntered)
    canvas.create_window(300,350,window=passEntered)
    Loginbutton=Button(canvas,text="Login",width=10,fg="yellow",bg="#000",font=("Arial",13,'bold'),command=validate)
    canvas.create_window(200,450,window=Loginbutton)
    Regbutton=Button(canvas,text="Register",width=10,fg="yellow",bg="#000",bd=0,font=("Arial",13,'bold'),command=RegisterPage)
    canvas.create_window(340,450,window=Regbutton)
    forgbutton=Button(canvas,text="Forgot Password",fg="yellow",bg="#000",bd=0,font=("Arial",10,'underline'),command=forgotpage)
    canvas.create_window(280,380,window=forgbutton)
    abutton=Button(canvas,text="Admin Login",fg="yellow",bg="#000",bd=0,font=("Arial",10,'underline'),command=adminloginpage)
